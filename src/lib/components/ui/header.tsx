...
import UfoProgress from "~/assets/ufoProgress.png";
      ...
      <div className="w-full flex justify-center relative">
        <div className="fixed top-0 left-0 w-full z-[100] flex justify-end md:justify-center items-center gap-3">
          ...
          >
            {!isOpen && (
              <div
                className="fixed md:absolute inset-0 max-h-12 md:max-h-18 max-w-[220px] md:max-w-[300px] bg-black/[0.1] bg-opacity-10 backdrop-filter md:transform-none md:left-0 left-1/2 md:translate-x-0 -translate-x-1/2 backdrop-blur-sm md:pl-3 pb-1 md:pr-3 "
                style={{
            ...
            >
              ...
              >
                {(isHovered || blinkState) && (
                  <motion.div
                    className="absolute top-1/2 left-1/2 w-18  h-18 bg-green-500 rounded-full blur-xl opacity-0"
          ...
          >
            ...
            >
              ...
              >
                {(isHovered || blinkState) && (
                  <motion.div
                    className="absolute top-1/2 left-1/2 w-18  h-18 bg-blue-500 rounded-full blur-xl opacity-0"
                    style={{ transform: "translate(-50%, -50%)" }}
                    animate={{ opacity: [0, 0.5, 0.8] }}
                    transition={{ duration: 0.3, ease: "easeInOut" }}
                  />
...
export { HeaderAdmin, HeaderAdminProgress, HeaderNormal, HeaderNormalProgress };
