...
function removePickedOption(groupOption: GroupOption, picked: Option[]) {
  ...
  for (const [key, value] of Object.entries(cloneOption)) {
    cloneOption[key] = value.filter((val) =>
      !picked.find((p) => p.value === val.value)
    );
  }
  return cloneOption;
}
 ...
 */
const CommandEmpty = ({ ref: forwardedRef, className, ...props }: React.ComponentProps<typeof CommandPrimitive.Empty> & { ref?: React.RefObject<HTMLDivElement | null> }) => {
...
const MultipleSelector = (
  ...
  return (
    <Command
      ...
      shouldFilter={commandProps?.shouldFilter !== undefined
        ? commandProps.shouldFilter
        : !onSearch} // When onSearch is provided, we don&lsquo;t want to filter the options. You can still override it.
